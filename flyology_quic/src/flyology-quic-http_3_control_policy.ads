with Ada.Streams;
with Flyology.QUIC.HTTP_3_Settings_Policy;
with Flyology.QUIC.HTTP_3_Stream_Policy;
with Flyology.QUIC.Varint_Policy;

--  Internal, proved HTTP/3 control-stream lifecycle policy.
private package Flyology.QUIC.HTTP_3_Control_Policy
  with Preelaborate,
       SPARK_Mode => On
is
...
end Flyology.QUIC.HTTP_3_Control_Policy;
