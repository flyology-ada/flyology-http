with Flyology.QUIC.QPACK_Integer_Policy;
with Flyology.QUIC.QPACK_Static_Table;

package body Flyology.QUIC.QPACK_Field_Section_Policy
  with SPARK_Mode => On
is
...
end Flyology.QUIC.QPACK_Field_Section_Policy;
