   ...
   begin
      ...
      One_RTT_Sender.Send
        (Item.Backend, Item.Sending.Key, Item.Sending.IV, Item.Sending.HP,
         Item.Destination, Number, Number_Length, Item.Key_Phase,
   ...
   begin
      ...
      One_RTT_Receiver.Receive
        (Item.Backend, Item.Receiving.Key, Item.Receiving.IV,
         Item.Receiving.HP,
         Long_Header_Policy.V1_Connection_ID_Length (Item.Local_ID.Length),
         Expected, Packet, Plaintext, Received);
      ...
      case Received.Status is
         ...
         when One_RTT_Receiver.Received =>
            if Received.Envelope.Destination /= Item.Local_ID then
               ...
               return;
            elsif Received.Key_Phase /= Item.Key_Phase then
               Plaintext := (others => 0);
