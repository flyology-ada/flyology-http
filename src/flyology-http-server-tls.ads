...
package Flyology.HTTP.Server.TLS is
   ...
   --  The discriminant is the borrowed TLS connection.
   ...
   --  @param Item TLS HTTP transport
   --  @param Data Destination buffer
   --  @param Last Last decrypted byte or close sentinel
